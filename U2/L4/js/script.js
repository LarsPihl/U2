...
function init() {
	...
	// Lägg på händelsehanterare
		...
		//att den stora bilden ersätts av en 'tom' bild. En lokal variabel 'i' används för genomsökningen.
...
function startGame() {
	...
	Återigen används en lokal variabel 'i' för genomsökning.*/
	for (let i = 0; i < 4; i ++) {
	...
	En lokal variabel 'i' används för genomsökning.*/
	for (let i = 0; i < 4; i++) {
...
function dragstartWord(e) { // e är Event-objektet
	...
	for (let i = 0; i < imgElems.length; i++) {//Alla bildelement får ett eventobjekt för 'dragover' och 'drop',
		//där 'wordOverImg' respektive 'wordOverImg' anropas. En lokal variabel 'i' används för genomsökning.
...
function checkAnswers() {
	...
	skickas tillbaks till anropsplatsen. En lokal variabel 'i' används för genomsökning.*/
	for (let i = 0; i < answerElems.length; i++) {
